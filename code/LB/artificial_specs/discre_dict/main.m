...
rng = 1; % set the seed.
N = 2; % number of spectrum units
load('dict_infos.mat','dict','dez','xe','ye') % load the dictionary's informations.
...
[y, pst, ampt] = lasso_simu(N, dict, snr);
...
dict_siz = size(dict);
N = dict_siz(2); % a number of the dictionary's columns 
...
figure
% drawing the ground truth spectrum density components.
...
saveas(gcf, 'indice_amplitude.png');
